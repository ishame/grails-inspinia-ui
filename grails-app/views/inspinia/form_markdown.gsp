...
<head>
    ...
    <asset:stylesheet src="/plugins/bootstrap-markdown/bootstrap-markdown.min.css" />
...
$("#some-textarea").markdown({autofocus:false,savable:false}) </pre>
    ...
    <!-- Bootstrap markdown -->
    <asset:javascript src="/plugins/bootstrap-markdown/bootstrap-markdown.js"/>
    <asset:javascript src="/plugins/bootstrap-markdown/markdown.js"/>
