                        ...
                        <div class="ibox">
                            <div class="ibox-content">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="text-center m-t-lg">
                                            <g:img src="/angular_logo.png" alt="AngularJS" />
                                        </div>
                                        <div class="text-center m-t-lg">
                                    ...
                                    <div class="col-md-4">
                                        <div class="text-center m-t-lg">
                                            <g:img src="/mvc_logo.png" alt="MVC" style="width: 120px"/>
                                        </div>
                                        <div class="text-center m-t-lg">
                                    ...
                                    <div class="col-md-4">
                                        <div class="text-center m-t-lg">
                                            <g:img src="/meteor_logo.png" alt="HTML" style="width: 200px;margin-top: 20px"/>
                                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="text-center m-t-lg">
                                            <g:img src="/html_logo.png" alt="HTML" style="width: 100px"/>
                                        </div>
                                        <div class="text-center m-t-lg">
                                    ...
                                    <div class="col-md-4">
                                        <div class="text-center m-t-lg">
                                            <g:img src="/rails_logo.png" alt="HTML" style="width: 80px"/>
                                        </div>
                                        <div class="text-center m-t-lg">
                                    ...
                                    <div class="col-md-4">
                                        <div class="text-center m-t-lg">
                                            <g:img src="/starter_logo.jpg" alt="HTML"/>
                                        </div>
                                        <div class="text-center m-t-lg">
