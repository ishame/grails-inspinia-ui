...
Ting dummy text of the printing and has been the industry's typesetting. Lorem Ipsum has been the industry's
    ...
    <!-- Diff march patch -->
    <asset:javascript src="/plugins/diff_match_patch/javascript/diff_match_patch.js"/>

    <!-- jQuery pretty text diff -->
    <asset:javascript src="/plugins/preetyTextDiff/jquery.pretty-text-diff.min.js"/>
