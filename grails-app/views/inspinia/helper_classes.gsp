                        ...
                        <div class="ibox-content">
                            <table class="table">
                                ...
                                <tr>
                                    ...
                                    <td><g:img src="/a4.jpg" class="img-circle img-md"/> </td>
                                </tr>
                                <tr>
                                    <td><code>.img-rounded</code></td>
                                    <td><g:img src="/a4.jpg" class="img-rounded img-md"/></td>
                                </tr>
                                <tr>
                                    <td><code>.img-thumbnail</code></td>
                                    <td><g:img src="/a4.jpg" class="img-thumbnail img-md"/></td>
                                </tr>
                                <tr>
                                    <td><code>.img-sm</code></td>
                                    <td><g:img src="/a4.jpg" class="img-sm"/></td>
                                </tr>
                                <tr>
                                    <td><code>.img-md</code></td>
                                    <td><g:img src="/a4.jpg" class="img-md"/></td>
                                </tr>
                                <tr>
                                    <td><code>.img-lg</code></td>
                                    <td><g:img src="/a4.jpg" class="img-lg"/></td>
                                </tr>
                                </tbody>
                            </table>
                        </div>
