...
<head>
    ...
    <!-- Ladda style -->
    <asset:stylesheet src="/plugins/ladda/ladda-themeless.min.css" />
...
var l = Ladda.bind('.ladda-button-demo');
    ...
    <!-- Ladda -->
    <asset:javascript src="/plugins/ladda/spin.min.js"/>
    <asset:javascript src="/plugins/ladda/ladda.min.js"/>
    <asset:javascript src="/plugins/ladda/ladda.jquery.min.js"/>
