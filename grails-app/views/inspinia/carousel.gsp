                            ...
                            <div class="carousel slide" id="carousel1">
                                <div class="carousel-inner">
                                    <div class="item active">
                                        <g:img alt="image" class="img-responsive" src="/p_big3.jpg" />
                                    </div>
                                    <div class="item">
                                        <g:img alt="image"  class="img-responsive" src="/p_big1.jpg" />
                                    </div>
                                    <div class="item ">
                                        <g:img alt="image" class="img-responsive" src="/p_big2.jpg" />
                                    </div>
