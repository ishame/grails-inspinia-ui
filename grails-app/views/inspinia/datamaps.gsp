...
{ strokeColor: '#2BA587', strokeWidth: 1}
        ...
        <!-- DataMaps -->
        <asset:javascript src="/plugins/typehead/bootstrap3-typeahead.min.js"/>
        <asset:javascript src="/plugins/d3/d3.min.js"/>
        <asset:javascript src="/plugins/topojson/topojson.js"/>
        <asset:javascript src="/plugins/datamaps/datamaps.all.min.js"/>
