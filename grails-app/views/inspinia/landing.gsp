        ...
        <div class="item active">
            <div class="container">
                ...
                <div class="carousel-image wow zoomIn">
                    <g:img src="/landing/laptop.png" alt="laptop" />
                </div>
            </div>
...
<section  class="container features">
    ...
    <div class="row">
        ...
        <div class="col-md-6 text-center  wow zoomIn">
            <g:img src="/landing/perspective.png" alt="dashboard" class="img-responsive" />
        </div>
    ...
    <div class="row features-block">
        ...
        <div class="col-lg-6 text-right wow fadeInRight">
            <g:img src="/landing/dashboard.png" alt="dashboard" class="img-responsive pull-right" />
        </div>
    </div>
</section>
        ...
        <div class="row">
            <div class="col-sm-4 wow fadeInLeft">
                <div class="team-member">
                    <g:img src="/landing/avatar3.jpg" class="img-responsive img-circle img-small" alt="" />
            ...
            <div class="col-sm-4">
                <div class="team-member wow zoomIn">
                    <g:img src="/landing/avatar1.jpg" class="img-responsive img-circle" alt="" />
            ...
            <div class="col-sm-4 wow fadeInRight">
                <div class="team-member">
                    <g:img src="/landing/avatar2.jpg" class="img-responsive img-circle img-small" alt="" />
    ...
    <div class="container">
        ...
        <div class="row features-block">
            ...
            <div class="col-lg-6 text-right m-t-n-lg wow zoomIn">
                <g:img src="/landing/iphone.jpg" class="img-responsive" alt="dashboard" />
            </div>
    ...
    <div class="container">
        ...
        <div class="row features-block">
            <div class="col-lg-4">
                ...
                <div class="comments-avatar">
                    <a href="" class="pull-left">
                        <g:img alt="image" src="/landing/avatar3.jpg" />
                    </a>
            ...
            <div class="col-lg-4">
                ...
                <div class="comments-avatar">
                    <a href="" class="pull-left">
                        <g:img alt="image" src="/landing/avatar1.jpg" />
                    </a>
                    <div class="media-body">
                        <div class="commens-name">
                            Andrew Williams
            ...
            <div class="col-lg-4">
                ...
                <div class="comments-avatar">
                    <a href="" class="pull-left">
                        <g:img alt="image" src="/landing/avatar2.jpg" />
                    </a>
                    <div class="media-body">
                        <div class="commens-name">
                            Andrew Williams
...
<asset:javascript src="/plugins/wow/wow.min.js"/>
