            ...
            <ul class="nav metismenu" id="side-menu">
                <li class="nav-header">
                    <div class="dropdown profile-element"><span>
                        <g:img dir="images" alt="image" class="img-circle" file="profile_small.jpg"/>
                    </span>
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-messages">
                            <li>
                                <div class="dropdown-messages-box">
                                    <a href="profile.html" class="pull-left">
                                        <g:img dir="images" alt="image" class="img-circle" file="a7.jpg" />
                                    </a>
                            ...
                            <li>
                                <div class="dropdown-messages-box">
                                    <a href="profile.html" class="pull-left">
                                        <g:img dir="images" alt="image" class="img-circle" file="a4.jpg" />
                                    </a>
                            ...
                            <li>
                                <div class="dropdown-messages-box">
                                    <a href="profile.html" class="pull-left">
                                        <g:img dir="images" alt="image" class="img-circle" file="profile.jpg" />
                                    </a>
                            ...
                            <div class="ibox float-e-margins">
                                ...
                                <div class="ibox-content no-padding">
                                    <ul class="list-group">
                                        <li class="list-group-item">
                                            <p><a class="text-info"
                                                  href="#">@Alan Marry</a> I belive that. Lorem Ipsum is simply dummy text of the printing and typesetting industry.
                                            </p>
                                        ...
                                        <li class="list-group-item">
                                            <p><a class="text-info"
                                                  href="#">@Stock Man</a> Check this stock chart. This price is crazy!
                                            </p>
                                        ...
                                        <li class="list-group-item">
                                            <p><a class="text-info"
                                                  href="#">@Kevin Smith</a> Lorem ipsum unknown printer took a galley
                                            </p>
                                        ...
                                        <li class="list-group-item ">
                                            <p><a class="text-info"
                                                  href="#">@Jonathan Febrick</a> The standard chunk of Lorem Ipsum</p>
                                ...
                                <div class="ibox-content">
                                    ...
                                    <div>
                                        <div class="feed-activity-list">
                                            ...
                                            <div class="feed-element">
                                                <a href="profile.html" class="pull-left">
                                                    <g:img dir="images" alt="image" class="img-circle" file="a2.jpg" />
                                                </a>
                                            ...
                                            <div class="feed-element">
                                                <a href="profile.html" class="pull-left">
                                                    <g:img dir="images" alt="image" class="img-circle" file="a3.jpg" />
                                                </a>
                                            ...
                                            <div class="feed-element">
                                                ...
                                                <div class="media-body ">
                                                    ...
                                                    <div class="actions">
                                                        ...
                                                        <a class="btn btn-xs btn-white"><i class="fa fa-heart"></i> Love
                                                        </a>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="feed-element">
                                                <a href="profile.html" class="pull-left">
                                                    <g:img dir="images" alt="image" class="img-circle" file="a5.jpg" />
                                                </a>
                        ...
                        <div class="col-lg-4">
                            <div class="ibox float-e-margins">
                                ...
                                <div class="ibox-content ibox-heading">
                                    ...
                                    <small><i
                                            class="fa fa-map-marker"></i> Meeting is on 6:00am. Check your schedule to see detail.
                                    </small>
                                </div>
                ...
                <div id="tab-1" class="tab-pane active">
                    ...
                    <div>
                        ...
                        <div class="sidebar-message">
                            <a href="#">
                                <div class="pull-left text-center">
                                    <g:img dir="images" alt="image" class="img-circle message-avatar" file="a1.jpg" />
                        ...
                        <div class="sidebar-message">
                            <a href="#">
                                <div class="pull-left text-center">
                                    <g:img dir="images" alt="image" class="img-circle message-avatar" file="a2.jpg" />
                                </div>
                        ...
                        <div class="sidebar-message">
                            <a href="#">
                                <div class="pull-left text-center">
                                    <g:img dir="images" alt="image" class="img-circle message-avatar" file="a3.jpg" />
                        ...
                        <div class="sidebar-message">
                            <a href="#">
                                <div class="pull-left text-center">
                                    <g:img dir="images" alt="image" class="img-circle message-avatar" file="a4.jpg" />
                                </div>
                        ...
                        <div class="sidebar-message">
                            <a href="#">
                                <div class="pull-left text-center">
                                    <g:img dir="images" alt="image" class="img-circle message-avatar" file="a8.jpg" />
                                </div>
                        ...
                        <div class="sidebar-message">
                            <a href="#">
                                <div class="pull-left text-center">
                                    <g:img dir="images" alt="image" class="img-circle message-avatar" file="a7.jpg" />
                                </div>
